                ...
                <div className="row justify-content-between">
                    ...
                    <div className="col-lg-4 mil-relative">
                        ...
                        <div className="mil-contact-sidebar">
                            ...
                            <img src="img/my-photo/foot.jpg" alt="img" style={{"width": "100%", "height": "200px", "objectFit": "cover", "objectPosition": "0 -60px"}} className="mil-mb-30" />
                        ...
                        <div className="row">
                            <div className="col-lg-4">
                                <div className="mil-up mil-mb-60">
                                    <span className="mil-suptitle mil-upper mil-up mil-mb-30">Point</span>
